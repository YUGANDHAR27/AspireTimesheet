...
public class TC08_Manager_ReportsPagePdf extends TestsuiteBase
{
	...
	{
		Extent_Report.getTestScript("ManagerreportsTab", "download The Employee Timesheet report in Pdf Format");
	    ...
	    Thread.sleep(3000);
		driver.findElement(By.xpath(load.readlocatorvalue("loc.downloadpdf.btn"))).click();//not working
		 Thread.sleep(3000);
